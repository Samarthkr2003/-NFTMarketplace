   ...
   >
     <div className="flex flex-col justify-center items-center mx-auto py-10">
       <div className="flex flex-col justify-center items-center">
         ...
         <a
           href="https://www.linkedin.com/in/samarthkr?lipi=urn%3Ali%3Apage%3Ad_flagship3_profile_view_base_contact_details%3B2lobLKwIQca2k3pR55qgBQ%3D%3D"
         ...
         >
           ...
           <div className="flex flex-col font-semibold">
             <span className="text-white text-sm">Samarth Kumar</span>
             <span className="text-[#e32970] text-xs">Details</span>
           </div>
         </a>

         <p className="text-white text-sm font-medium text-center">
         Discover a world of unique and extraordinary digital art as you explore our platform. 
<br /> We provide a seamless and secure environment for artists and collectors to mint, showcase, <br /> and trade their one-of-a-kind Non-Fungible Tokens (NFTs).
         </p>
         ...
         <ul className="flex flex-row justify-center space-x-2 items-center my-4">
           <a
             ...
             href="https://github.com/Samarthkr2003"
           >
             <img className="w-7 h-7" src={github} alt="Github" />
           </a>
           <a
             className="bg-white hover:scale-50 transition-all duration-75 delay-75 rounded-full mx-2"
             href="https://www.linkedin.com/in/samarthkr?lipi=urn%3Ali%3Apage%3Ad_flagship3_profile_view_base_contact_details%3BpyaKdPE8SQeTkM7mn4%2Fd2w%3D%3D"
           >
